...
/**
 * The `Vouch.` wordmark — Fraunces, matching the taste-pivot type stack used
 * everywhere else in the app. The dot is always coral regardless of the
 * `color` prop so it reads as a deliberate mark, not punctuation. The dot is
